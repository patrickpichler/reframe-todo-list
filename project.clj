(defproject reframe-todo-list "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot reframe-todo-list.core
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "reframe-todo-list.jar"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "reframe-todo-list.core/mount-components"}
                     :compiler
                     {:main "reframe-todo-list.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
                   ...
                   {:test
                    {:source-paths ["src/cljc" "src/cljs" "test/cljs"]
                     ...
                     {:output-to "target/test.js"
                      :main "reframe-todo-list.doo-runner"
