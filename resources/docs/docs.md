...
The `home-routes` handler in the `reframe-todo-list.routes.home` namespace
...
The `home-page` function will in turn call the `reframe-todo-list.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/reframe_todo_list/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `reframe-todo-list.handler` namespace:
...
Request middleware functions are located under the `reframe-todo-list.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `reframe-todo-list.dev-middleware` namespace found in
